                    ...
                    favourites.map((item) => (
                        <a href={
                            ...
                            <div className="relative">
                                <img src={`${import.meta.env.VITE_HOST}${item.mainImageURL}`} alt={item.title} className="w-full h-52 object-contain p-3 transition-all duration-200 ease-linear group-hover:scale-105 " />
                            ...
                            <div className="p-3">
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    <p className="text-xs text-red-500 line-through font-semibold">{currency} {item.comparedPrice}</p>
                                </div>
                            </div>
                        </a>
                    ))
