...
import { BiCopy, BiCheck, BiCustomize } from "react-icons/bi";
        ...
        <>
            ...
            <div className='seller-container'>
                ...
                <div className='flex justify-between items-center bg-white p-6 border border-gray-200 my-4 light-shad'>
                    ...
                    >
                        {copied ? <BiCheck size={14} className='text-green-600' /> : <BiCopy size={14} />}
                        {copied ? 'Copied' : 'Copy Link'}
                    </button>
                </div>

                <div className="bg-white border border-gray-200 p-6 light-shad">
