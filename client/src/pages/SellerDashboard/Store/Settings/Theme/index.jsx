                    ...
                    <div className='flex items-center gap-5 mt-3'>
                        {
                            logoPreview ? (
                                ...
                                <img src={`${import.meta.env.VITE_HOST}${state.logo}`} alt="logo" className='w-48 h-16 object-contain' />
                            ) : (
                    ...
                    <div className='flex items-center gap-5 mt-3'>
                        {
                            faviconPreview ? (
                                ...
                                <img src={`${import.meta.env.VITE_HOST}${state.favicon}`} alt="favicon" className='w-14 h-14 object-contain' />
                            ) : (
