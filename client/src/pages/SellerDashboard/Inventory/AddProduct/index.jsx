...
export default function AddProduct() {
    ...
    const handleAddProduct = () => {
        ...
        if (variants.length > 0) {
            const hasInvalidVariant = variants.some(v => Number(v.price || 0) <= 0 || Number(v.stock || 0) < 0);
                                                ...
                                                {results.map(product => (
                                                    ...
                                                    >
                                                        ...
                                                        <span className="text-xs text-gray-500">
                                                            <span className='text-red-400 line-through text-[11px]'>{product.comparedPrice}</span>{" "}
                                                            {product.price}
                                                        </span>
                                                    </li>
                                                ))}
