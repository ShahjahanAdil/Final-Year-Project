                    ...
                    >
                        ...
                        <div className='flex flex-col gap-4 flex-1 p-6 overflow-y-auto'>
                            <div>
                                ...
                                <textarea name="state" id="state" rows={6} value={state || ""} placeholder={`Paste full ${selectedTag?.name} tag here`} className='w-full text-sm !p-2 mt-3 border border-gray-200 !rounded-none outline-none resize-none focus:border-[var(--secondary)]'
                        ...
                        <div className='flex justify-between items-center p-6 border-t border-gray-200'>
                            ...
                            <div className='flex gap-3'>
                                ...
                                <button className='px-4 py-1.5 bg-[var(--secondary)] text-white disabled:opacity-70'
                                    disabled={adding}
