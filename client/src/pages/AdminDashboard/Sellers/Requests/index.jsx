                ...
                >
                    ...
                    >
                        <div className='flex justify-between items-center px-6 py-5 border-b border-gray-200'>
                            <div>
                                <p className='font-bold text-gray-900 text-lg'>Seller Application Details</p>
                                <p className='text-xs text-gray-500'>Review seller information before approval</p>
                            </div>
                        ...
                        <div className='h-[calc(100vh-150px)] overflow-y-auto p-6 bg-[#f8fafc]'>
                            <div className='bg-white border border-gray-200 p-5 mb-5'>
                                <div className='flex flex-col md:flex-row md:items-center justify-between gap-4'>
                                    <div>
                                        ...
                                        <h2 className='text-2xl font-bold text-gray-900'>{selectedSeller?.brandName || '-'}</h2>
                                        <p className='text-sm text-gray-500 mt-1'>/{selectedSeller?.brandSlug || '-'}</p>
                                    </div>
                                ...
                                <div className='bg-white border border-gray-200 p-5'>
                                    ...
                                    <div className='space-y-4'>
                                        <div>
                                            ...
                                            <p className='text-sm font-semibold text-gray-900'>{selectedSeller?.userID || '-'}</p>
                                        </div>

                                        <div>
                                            <p className='text-xs text-gray-500'>Full Name</p>
                                            <p className='text-sm font-semibold text-gray-900'>{selectedSeller?.fullname || '-'}</p>
                                        </div>

                                        <div>
                                            <p className='text-xs text-gray-500'>Username</p>
                                            <p className='text-sm font-semibold text-gray-900'>{selectedSeller?.username || '-'}</p>
                                        </div>

                                        <div>
                                            <p className='text-xs text-gray-500'>Email</p>
                                            <p className='text-sm font-semibold text-gray-900 break-all'>{selectedSeller?.email || '-'}</p>
                                        </div>

                                        <div>
                                            <p className='text-xs text-gray-500'>Role</p>
                                            <p className='text-sm font-semibold text-gray-900 capitalize'>{selectedSeller?.role || '-'}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className='bg-white border border-gray-200 p-5'>
                                    ...
                                    <div className='space-y-4'>
                                        <div>
                                            ...
                                            <p className='text-sm font-semibold text-gray-900'>{selectedSeller?.phoneNumber || '-'}</p>
                                        </div>

                                        <div>
                                            <p className='text-xs text-gray-500'>WhatsApp Number</p>
                                            <p className='text-sm font-semibold text-gray-900'>{selectedSeller?.whatsappNumber || '-'}</p>
                                        </div>

                                        <div>
                                            <p className='text-xs text-gray-500'>CNIC Number</p>
                                            <p className='text-sm font-semibold text-gray-900'>{selectedSeller?.cnic || '-'}</p>
                                        </div>

                                        <div>
                                            <p className='text-xs text-gray-500'>Address</p>
                                            <p className='text-sm font-semibold text-gray-900'>{selectedSeller?.address || '-'}</p>
                                        </div>

                                        <div>
                                            <p className='text-xs text-gray-500'>Registered At</p>
                                            <p className='text-sm font-semibold text-gray-900'>
                                                {selectedSeller?.createdAt ? dayjs(selectedSeller.createdAt).format('DD MMM YYYY HH:mm') : '-'}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className='bg-white border border-gray-200 p-5 mt-5'>
                                <p className='font-bold text-gray-900 mb-4'>Subscription / Trial Preview</p>

                                <div className='grid grid-cols-1 sm:grid-cols-3 gap-4'>
                                    <div className='bg-[#f8fafc] border border-gray-100 rounded-lg p-4'>
                                        <p className='text-xs text-gray-500'>Current Plan</p>
                                        <p className='text-sm font-bold text-gray-900'>{selectedSeller?.plan || 'No Plan'}</p>
                                    </div>

                                    <div className='bg-[#f8fafc] border border-gray-100 rounded-lg p-4'>
                                        <p className='text-xs text-gray-500'>Subscription Status</p>
                                        <p className='text-sm font-bold text-gray-900 capitalize'>{selectedSeller?.subscriptionStatus || 'none'}</p>
                                    </div>

                                    <div className='bg-[#f8fafc] border border-gray-100 rounded-lg p-4'>
                                        <p className='text-xs text-gray-500'>Trial / Plan Expiry</p>
                                        <p className='text-sm font-bold text-gray-900'>
                                            {selectedSeller?.subscriptionEndsAt ? dayjs(selectedSeller.subscriptionEndsAt).format('DD MMM YYYY') : '-'}
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className='flex justify-end gap-3 px-6 pt-4 border-t border-gray-200 bg-white'>
                            <button
                            ...
                            <button
                                className='px-5 py-2 bg-[#f73535] text-white text-sm font-semibold hover:bg-[#d92d2d]'
