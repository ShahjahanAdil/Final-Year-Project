    ...
    <section className="py-12 md:py-16">
      <div className="max-w-[1140px] mx-auto px-4">
          ...
          <div className="xl:col-span-4">
            <div className="xl:sticky xl:top-24">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4">
                Bigger Brands Trust Sorty
              </h2>
              <p className="text-base md:text-lg leading-relaxed mb-6 text-[var(--text)]">
                Top business leaders and brands around the world choose Sorty
              ...
              <div className="hidden xl:block">
                <h6 className="font-semibold mb-3 text-lg">
                  Learn more details about Sorty platform to build your
                  eCommerce marketplace
                </h6>
                <a
                  href="#"
                  className="inline-block bg-[#EE3E5A] text-white px-5 py-2 rounded-md font-medium shadow-md transition-all duration-300 hover:opacity-90 hover:scale-105"
                >
                  Request a Free Demo
                </a>
              </div>
        ...
        <div className="mt-8 text-center xl:hidden">
          <a
            href="#"
            className="inline-block bg-[#EE3E5A] text-white px-6 py-2 rounded-md font-medium shadow-md transition-all duration-300 hover:opacity-90 hover:scale-105"
          >
            Request a Free Demo
          </a>
        </div>
