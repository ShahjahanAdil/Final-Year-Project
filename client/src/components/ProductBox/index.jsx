        ...
        >
            ...
            <div className="p-3 sm:p-4 flex flex-col flex-grow">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center gap-2 whitespace-nowrap mt-2 sm:mt-3">
                    ...
                    <button className='w-full sm:w-fit flex justify-center items-center mt-1 sm:mt-0 gap-1 text-[9px] sm:text-[11px] border border-[var(--pr)] rounded-full text-[var(--pr)] font-bold p-1 sm:px-2 sm:py-1.5 hover:bg-[var(--pr)] hover:text-white disabled:opacity-70'
                        disabled={adding}
                    ...
                    >
                        {adding ? "Adding..." :
                            <>
                                ...
                                {hasMultipleVariants || hasOptions ? "Choose Option" : "Add to Cart"}
                            </>
                        }
                    </button>
                </div>
            ...
            <div className="absolute top-3 right-3 transition-all duration-300 ease-out opacity-0 p-2.5 rounded-xl bg-[var(--pr)]/10 group-hover:opacity-100"
                onClick={handleAddToFavourites}
            >
                {addingToFavourites ? (
                    <ButtonLoader />
                ) : (
                    <Heart size={18} className={isFavourite ? 'text-red-500 fill-red-500' : 'text-[#666] hover:text-red-500'} />
                )}
            </div>
        </a>
    )
