...
export default function ProductBoxThree({ item, idx, settings, isCustomDomain }) {
        ...
        >
            <div className="relative w-full h-60 sm:h-70 overflow-hidden bg-gray-50 rounded-2xl border border-gray-100 hover:border-[var(--pr)]/30 transition-all duration-300 ease-linear">
                ...
                <img
                    ...
                    className={`w-full h-full object-contain p-3 sm:p-4 transition-transform duration-700 ease-in-out group-hover:scale-110 ${loading ? "opacity-0" : "opacity-100"
                        }`}
                />
