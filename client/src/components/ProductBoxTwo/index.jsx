        ...
        >
            <div className="relative w-full h-42 sm:h-56 md:h-72 overflow-hidden bg-gray-100 rounded-lg">
                ...
                <div className="absolute inset-0 flex flex-row items-end justify-center gap-5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 ease-out bg-black/5 ">
                    <button className='w-fit rounded-[8px] text-xs bg-white text-gray-800 font-bold p-2.5 mb-10 hover:bg-[var(--pr)] hover:text-white disabled:opacity-70'
                        disabled={adding}
                    ...
                    <div className="p-2 rounded-[8px] bg-white hover:bg-red-100 transition-all duration-200 mb-10"
                        onClick={handleAddToFavourites}
                    >
                        {addingToFavourites ? (
                            <ButtonLoader />
                        ) : (
                            <Heart size={20} className={isFavourite ? 'text-red-500 fill-red-500' : 'text-[#666] hover:text-red-500'} />
                        )}
                    </div>
                </div>
