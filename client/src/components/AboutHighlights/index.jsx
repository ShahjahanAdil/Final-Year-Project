...
//                 </div>
//             </div>
//             <div className='yokart-highlight flex bg-[var(--secondary)]'>
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
         ...
         <p className="text-base md:text-lg text-[var(--text)] leading-relaxed">
          An impactful launch backed by a brilliant response encouraged the
            ...
            team to invest more in multi-vendor software. Sorty transformed FATbit’s dynamics,
