...
router.post("/update", upload.any(), async (req, res) => {
    try {
        ...
        //         ...variant,
        //         imageURL: file
        //             ? `/uploads/${file.filename}` // new uploaded image
        ...
        const baseComparedPrice =
            comparedPrice !== undefined && comparedPrice !== null && comparedPrice !== ""
        ...
        const updatedVariants = parsedVariants.map(variant => {
            ...
            return {
                ...
                price: Number(variant.price || basePrice || 0),
                comparedPrice:
                    variant.comparedPrice !== undefined &&
                        variant.comparedPrice !== null &&
